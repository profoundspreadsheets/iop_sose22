# tested on my machine with saxon 10.6, as it was only package available on AUR, sorry
...
java -cp saxon-he-11.3.jar net.sf.saxon.Query -q:1_query.xq -o:1_output.xml
...
java -cp saxon-he-11.3.jar net.sf.saxon.Query -q:2_query.xq -o:2_output.xml
...
java -cp saxon-he-11.3.jar net.sf.saxon.Query -q:3_query.xq -o:3_output.xml
...
java -cp saxon-he-11.3.jar net.sf.saxon.Query -q:4_query.xq -o:4_output.xml
